                ...
                <div className="prose prose-sm max-w-none dark:prose-invert">
                  <div className="text-foreground leading-relaxed space-y-3">
                    {getContent(selectedNews).split('\n\n').map((paragraph, idx) => {
                      ...
                      if (trimmed.startsWith('📖') || trimmed.startsWith('✅') || trimmed.startsWith('💫') || trimmed.startsWith('🌳') || trimmed.startsWith('♻️') || trimmed.startsWith('🌍') || trimmed.startsWith('⚡️') || trimmed.startsWith('🎯') || trimmed.startsWith('📸')) {
                        return (
